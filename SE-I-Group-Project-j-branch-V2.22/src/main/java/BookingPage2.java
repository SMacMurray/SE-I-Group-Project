        ...
        addRoomButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		if (y < 0) {
        			...
        			int roomNumber = (int)table.getValueAt(y, 0);
        		...
        		try {
            		...
            		Room room = GlobalVariables.rs.getRoom((int)table.getValueAt(y, 0));
            		int guests = Integer.parseInt(guestsBox.getText());
            		GlobalVariables.reS.reserveRoom(room, startDate, endDate, guests);
        		}
